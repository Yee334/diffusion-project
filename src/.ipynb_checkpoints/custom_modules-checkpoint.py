...
class FrozenCLIPEmbedderWrapper(AbstractEncoder):
    ...
    def __init__(self, modifier_token, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained("/mnt/workspace/custom-diffusion/clip-vit-large-patch14")

        # self.transformer = CLIPTextModel.from_pretrained(version)
        self.transformer = CLIPTextModel.from_pretrained("/mnt/workspace/custom-diffusion/clip-vit-large-patch14")
